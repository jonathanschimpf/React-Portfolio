...
function HelloComponent() {
  return (
    <>
      <div id="about">
        <Container className="containerBackground helloContainer" fluid>
          <Container className="helloMargins">
            <h1 className="wow animate__animated animate__fadeInDown animate_slower helloSize">
            ...
            <p className="lead helloParagraph wow animate__animated animate__fadeInUp animate_slower">
              <span className="wow animate__animated animate__fadeIn animate_slower">
                <span style={{ fontWeight: "bold", color: "white" }}>
                  I am a Junior Web Developer
                </span>{" "}
                who has a commercial art background with a specialized focus in
